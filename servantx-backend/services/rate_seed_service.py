...
RATE_FILES: List[Dict[str, str]] = [
    {
        ...
        "path": str(REPO_ROOT / "data" / "normalized_rate_imports" / "medicare_mpfs_2026.csv"),
    },
    {
        "payer_key": "MEDICARE_GPCI",
        "version_label": "CMS GPCI 2026",
        "source_url": "https://www.cms.gov/files/zip/rvu26a-updated-12-29-2025.zip",
        "path": str(REPO_ROOT / "data" / "normalized_rate_imports" / "medicare_gpci_2026.csv"),
    },
    {
        "payer_key": "MEDICARE_CONVERSION_FACTOR",
        "version_label": "CMS Conversion Factor 2026",
        "source_url": "https://www.cms.gov/files/zip/rvu26a-updated-12-29-2025.zip",
        "path": str(REPO_ROOT / "data" / "normalized_rate_imports" / "medicare_conversion_factor_2026.csv"),
    },
    {
        ...
        "path": str(REPO_ROOT / "data" / "normalized_rate_imports" / "medicare_zip_locality_2026.csv"),
    },
    {
        ...
        "path": str(REPO_ROOT / "data" / "normalized_rate_imports" / "tx_medicaid_ffs_expanded_2026.csv"),
    },
]
